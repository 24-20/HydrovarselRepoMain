...
const AlertInput = ({ className='', type, placeholder, updateState, state }:CardProps) => {
    ...
    return (
        <input className=' w-[150px] border border-border bg-card-foreground shadow-md px-4 h-[34px] flex gap-2 items-center rounded-lg outline-2 outline-border lg:text-lg hover:outline'
